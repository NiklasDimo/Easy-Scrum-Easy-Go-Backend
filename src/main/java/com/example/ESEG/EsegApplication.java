...
public class EsegApplication {
	...
	CommandLineRunner commandLineRunner(DetailsRepository detailsRepository, ProductRepository repository, ImpressumRepository impressumRepository, UserRepository userRepository, AddressRepository addressRepository) {
		return args -> {
			...
			repository.save(new Product("Playstation 5", "€", 10.50, "Von Haus aus steckt in der PS5 eine SSD-Festplatte mit 825 Gigabyte Speicher. Sollte euch das nicht reichen, könnt ihr die Konsole per NVMe SSD Slot durch eine weitere Festplatte erweitern.", "Maße: 10x20", "Konsole"));
			repository.save(new Product("Nintendo Switch", "$", 5.99, "Das neue Modell ist in etwa so breit und so hoch wie die Nintendo Switch-Konsole, besitzt aber einen größeren 7-Zoll-OLED-Bildschirm mit intensiver Farbdarstellung und hohem Kontrast.", "Maße: 10x20 : Gewicht: 10kg", "Konsole"));
